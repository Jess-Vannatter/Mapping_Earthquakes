...
let torontoData = "https://raw.githubusercontent.com/Jess-Vannatter/Mapping_Earthquakes/Mapping_GeoJSON_Linestrings/torontoRoutes.json";
...
// // Grabbing our GeoJSON data.
// d3.json(orontoData).then(function(data) {
//     console.log(data);
//   // Creating a GeoJSON layer with the retrieved data.
//   L.geoJSON(data, {
